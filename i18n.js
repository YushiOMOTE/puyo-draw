  ...
  ja: {
    app: {
      ...
      controlHelp: {
        ...
        tokopuyo: { reset: "新しいランダムパターンで最初から始めます。", mode: "描画モードに戻ります。", help: "この操作説明を開きます。", undo: "配置済みの組ぷよまたはおじゃまぷよ1手分を元に戻します。", redo: "元に戻した組ぷよまたはおじゃまぷよ1手分をやり直します。", suggest: "長連鎖を構築するための手を提案します。", attack: "見えているツモ内で最大得点の安全な攻撃を探します。", review: "直前の配置をPressureless Amaの分析と比較します。", stepMode: "連鎖ステップモードをオン・オフします。", garbage: "通常のCurrentを消費せず、動かせるおじゃまぷよ1個に切り替えます。" },
