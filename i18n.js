...
const translations = {
  en: {
    app: {
      ...
      returnDrawing: "Switch to Drawing mode",
      help: "How to use",
      ...
      tokopuyoGarbageOn: "Enable Tokopuyo garbage mode",
      tokopuyoGarbageOff: "Disable Tokopuyo garbage mode",
      ...
      controlHelp: {
        ...
        tokopuyo: { reset: "Start a new random pattern.", searchTsumo: "Search and select a predefined Tsumo pattern.", mode: "Switch to Drawing mode.", help: "Open this help.", undo: "Undo one complete placed pair or garbage puyo.", redo: "Restore one undone placed pair or garbage puyo.", suggest: "Suggest a resilient long-chain construction move.", attack: "Find the highest-scoring safe attack in the visible pairs.", review: "Compare the last placed pair with Pressureless Ama's analysis.", stepMode: "Enable or disable chain step mode.", garbage: "Switch to garbage puyo placement mode." },
    ...
    message: {
      ...
      tokopuyoGarbageMode: (enabled) => `Tokopuyo garbage mode ${enabled ? "on" : "off"}`,
  ...
  ja: {
    app: {
      ...
      controlHelp: {
        ...
        tokopuyo: { reset: "新しいランダムパターンで最初から始めます。", mode: "描画モードに切り替えます。", help: "この操作説明を開きます。", undo: "配置済みの組ぷよまたはおじゃまぷよ1手分を元に戻します。", redo: "元に戻した組ぷよまたはおじゃまぷよ1手分をやり直します。", suggest: "長連鎖を構築するための手を提案します。", attack: "見えているツモ内で最大得点の安全な攻撃を探します。", review: "直前の配置をPressureless Amaの分析と比較します。", stepMode: "連鎖ステップモードをオン・オフします。", garbage: "おじゃまぷよを配置するモードに切り替えます。" },
    ...
    message: {
      ...
      tokopuyoGarbageMode: (enabled) => `とこぷよのおじゃまモードを${enabled ? "オン" : "オフ"}にしました`,
