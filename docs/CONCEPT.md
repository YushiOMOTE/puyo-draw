...
8. The user can switch to a separate step-driven Tokopuyo practice mode, place official-style four-color pairs through flick controls, preview the next two pairs, and let chains resolve automatically after each placement.
