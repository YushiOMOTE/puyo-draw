...
10. After committing a Tokopuyo pair, the user can review that move against Pressureless Ama's analysis of the exact pre-move field, Current, and Next. The review reports objective rank, sampled-future score, and branch-by-branch comparison without assigning an absolute grade or claiming that individual static features caused Ama's choice.
