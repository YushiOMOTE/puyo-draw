...
- Pressing a field cell selects its column and opens a four-direction flick menu. The four options preview the pair's colors and resulting orientation. Moving onto an option updates the upper pair preview to that option's placement orientation. Down places straight, right and left rotate 90 degrees, and up rotates 180 degrees before placing. Returning to the center or releasing below the flick threshold cancels.
