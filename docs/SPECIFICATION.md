...
- Pressing a field cell selects its column and opens a four-direction flick menu. The four options preview the pair's colors and resulting orientation. Down places straight, right and left rotate 90 degrees, and up rotates 180 degrees before placing. Releasing below the flick threshold cancels.
