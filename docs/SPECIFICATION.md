...
- The review identifies whether the user's move is Ama's first choice, a score-tied alternative, or a different recommendation. Ranking starts with the user's ordinal rank among the returned legal moves. Future potential and stability report both six-branch average, minimum, and maximum found chain scores.
